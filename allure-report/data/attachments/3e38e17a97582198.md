...
Call log:
  - waiting for locator('#input-confirm')
    - locator resolved to <input value="" name="confirm" type="password" id="input-confirm" class="form-control" placeholder="Password Confirm"/>
    - fill("ls5zmQzrZFKNmQ9")
  - attempting fill action
    - waiting for element to be visible, enabled and editable

    at RegisterPage.registerUser (C:\Users\JINTO\lamdatest-e2e-playwright\pages\RegisterPage.js:35:37)
...
- group "Your Personal Details":
  ...
  - textbox "First Name*": Schuyler
  - text: Last Name*
  - textbox "Last Name*": Hessel
  - text: E-Mail*
  - textbox "E-Mail*": Schuyler.Hessel89@yahoo.com
  - text: Telephone*
  - textbox "Telephone*": 1-475-372-4188
  - text: Enter valid phone number with country code!
- group "Your Password":
  - text: Your Password Password*
  - textbox "Password*": ls5zmQzrZFKNmQ9
