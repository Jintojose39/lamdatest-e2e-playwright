...
- group "Your Personal Details":
  ...
  - textbox "First Name*": Ophelia
  - text: Last Name*
  - textbox "Last Name*": Kozey
  - text: E-Mail*
  - textbox "E-Mail*": Ophelia_Kozey39@gmail.com
  - text: Telephone*
  - textbox "Telephone*": 1-748-451-7069 x191
  - text: Enter valid phone number with country code!
- group "Your Password":
  - text: Your Password Password*
  - textbox "Password*": POhKpVgJJTAdY1N
  - text: Password Confirm*
  - textbox "Password Confirm*": POhKpVgJJTAdY1N
- group "Newsletter":
